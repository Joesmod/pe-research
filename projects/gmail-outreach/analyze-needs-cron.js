...
// Read the sheet data
const data = JSON.parse(fs.readFileSync('sheet-data-march6-936am.json', 'utf8'));
...
// Save full list
fs.writeFileSync('leads-needing-enrichment-cron.json', JSON.stringify(needsEnrichment, null, 2));
