...
(async () => {
  ...
  // Save results
  fs.writeFileSync('apollo-enrichment-real-pe-march5.json', JSON.stringify(results, null, 2));
  ...
  console.log(`\n💾 Results saved to: apollo-enrichment-real-pe-march5.json`);
  ...
  if (totalContacts > 0) {
    ...
    for (const result of results) {
      if (result.contacts.length > 0 && shown < 5) {
