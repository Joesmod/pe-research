...
async function main() {
  console.log('=== Finding Enrichment Targets ===\n');
  ...
  // Pick first 15 that don't have status "Researched" (to avoid re-trying recently failed ones)
  ...
  // Save to file
  fs.writeFileSync(
    'selected-targets-0336pm.json',
    JSON.stringify(freshTargets, null, 2)
  );

  console.log(`\n✓ Saved to selected-targets-0336pm.json`);
}
