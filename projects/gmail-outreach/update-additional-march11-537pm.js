...
const findings = JSON.parse(fs.readFileSync('additional-findings-march11-537pm.json', 'utf8'));
...
async function main() {
  ...
  console.log('📊 Updating Google Sheet with additional enrichment findings...\n');
  ...
  console.log(`📝 Updated ${findings.length} additional leads with verified contacts`);
