...
const targets = JSON.parse(fs.readFileSync('selected-targets-batch2.json', 'utf8'));
...
async function main() {
  console.log('=== PE ENRICHMENT CRON RUN (Batch 2) ===');
  ...
  // Save log
  const logFile = 'enrichment-log-batch2.json';
