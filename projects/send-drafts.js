...
const recipients = ['ben@lyleburn.com', 'jeff@hellogumbo.com', 'steve@hellogumbo.com', 'alex@hellogumbo.com'];

const drafts = [
  {
    num: 2, firm: 'Kohlberg & Company',
    subject: 'Draft Outreach Emails for Review (2 of 5) - Kohlberg & Company',
...
Subject: Partnering on AI implementation across Kohlberg portfolio
...
Gumbo | hellogumbo.com`
  ...
  {
    num: 3, firm: 'Diversis Capital',
    subject: 'Draft Outreach Emails for Review (3 of 5) - Diversis Capital',
    body: `DRAFT 3 - Diversis Capital (Kevin Ma, Co-Founder & Managing Partner)
Score: 9 | Focus: Software, Tech-Enabled Services

Subject: AI engineering studio for Diversis portfolio builds
...
Gumbo | hellogumbo.com`
  ...
  {
    num: 4, firm: 'Align Capital Partners',
    subject: 'Draft Outreach Emails for Review (4 of 5) - Align Capital Partners',
...
Subject: AI development partner for Align's B2B portfolio
...
Gumbo | hellogumbo.com`
  ...
  {
    num: 5, firm: 'Gauge Capital',
    subject: 'Draft Outreach Emails for Review (5 of 5) - Gauge Capital',
...
Subject: Engineering capacity for AI initiatives at Gauge portfolio cos
  ...
  for (const d of drafts) {
    for (const to of recipients) {
      try {
        ...
        console.log(`${d.firm} -> ${to}: ${out.trim()}`);
      } catch (e) {
        console.error(`FAIL ${d.firm} -> ${to}: ${e.message}`);
      }
    }
  }
})();
