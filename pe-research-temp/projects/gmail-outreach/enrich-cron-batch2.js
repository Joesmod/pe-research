...
// Additional target firms to enrich
const TARGET_FIRMS = [
  { index: 524, company: 'Levine Leichtman Capital Partners, LLC' },
  { index: 530, company: 'Peninsula Capital Partners L.L.C.' },
];
...
async function main() {
  ...
  // Save log
  const logFile = `enrichment-log-batch2-${new Date().toISOString().split('T')[0]}.json`;
